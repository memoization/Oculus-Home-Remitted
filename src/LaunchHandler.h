...
private:
    ...
    bool InEmptyDashboard(bool ocDashActive); // true when no real scene app is in the foreground
    ...
    bool autoLaunchedHome = false; // Whether the auto-launch feature started home
    bool openvrReady = false; // OpenVR apis initialized
